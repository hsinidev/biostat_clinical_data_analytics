<div align="center">
  ...
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=0,2,2,5,30&height=180&section=header&text=Biostat%20Clinical%20Data%20An&fontSize=42&fontColor=fff&animation=fadeIn&fontAlignY=38" width="100%" style="max-width: 100%; border-radius: 12px; margin-bottom: 20px;" alt="Biostat Clinical Data Analytics Header Banner" />

  <h1>🚀 Biostat Clinical Data Analytics</h1>
  ...
  <p align="center">
    ...
    <a href="https://github.com/hsinidev/biostat_clinical_data_analytics"><img src="https://img.shields.io/badge/License-MIT-green?style=for-the-badge" alt="License: MIT" /></a>
  </p>
...
**Biostat Clinical Data Analytics** delivers a fast, responsive, and cross-platform browser experience built with **HTML** and hardware-accelerated canvas rendering.
...
```bash
git clone https://github.com/hsinidev/biostat_clinical_data_analytics.git
cd biostat_clinical_data_analytics
```
